...
def render_compliance_matrix(evaluation: BenchmarkEvaluation) -> str:
    ...
    rows = (
        ...
        ("Per-room floor/wall/ceiling plan", "Partial", "Floor outline, wall planes, and optional ceiling are published; convex area can be provisional."),
        ...
        ("Rendered plan", "Implemented with limitations", "SVG/PNG plan exists; outline is convex and may bridge unscanned/concave regions."),
